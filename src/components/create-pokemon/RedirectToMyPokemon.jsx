...
function RedirectToMyPokemon() {
  return (
    <div className="fixed top-10 left-8 z-50 flex flex-col items-end gap-2">
      <Tooltip title="My Pokémon" placement="left" arrow>
        <button className="bg-blue-500 px-5 py-5 rounded-sm">
          <Link
            to="/my-pokemon"
...
export default RedirectToMyPokemon;
